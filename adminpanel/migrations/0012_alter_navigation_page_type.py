...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adminpanel', '0011_remove_navigation_banner_image1_navigation_brochure'),
    ]
